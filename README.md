...
The purpose of this epository is to provide a faster host via github (since their mirror is often very slow) and also to provide an AppImage with all the advantages of the case: isolation, delta updates, portability and so on.
